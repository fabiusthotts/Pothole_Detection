...
loadedModel = load_model('C:\\Users\\HP\\Desktop\\full_model.h5')

camera = cv2.VideoCapture("C:\\Users\\HP\\Desktop\\VID20201101091410.mp4")
...
while (True):
    ...
    if(show_pred):
        cv2.putText(clone , "Pothole"+' '+str(prob*100)+'%' , (30,30) , cv2.FONT_HERSHEY_DUPLEX , 1 , (0,255,0) , 1)
